...
angular.module("ngGrid").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("aggregateCellTemplate.html",
    "<div class=\"ngCellText\" ng-class=\"col.colIndex()\"><span ng-cell-text></span></div>"
  );

  $templateCache.put("aggregateRowTemplate.html",
    "<div ng-show=\"showAggregateRow\" class=\"ngAggregateRowPanel\">\n" +
    "    <div ng-style=\"{ 'cursor': row.cursor }\" ng-repeat=\"col in renderedColumns\" ng-class=\"col.colIndex()\" class=\"ngCell {{col.cellClass}}\">\n" +
    "        <div class=\"ngVerticalBar\" ng-style=\"{height: rowHeight}\" ng-class=\"{ ngVerticalBarVisible: !$last }\">&nbsp;</div>\n" +
    "        <div ng-aggregate-cell></div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
    "\n"
